class FsharpPackage(GitHubTarballPackage):
	def __init__(self):
		...
		self.sources.extend (['patches/fsharp-fix-mdb-support.patch', 'patches/fsharp-use-standard-resource-names.patch', 'patches/fsharp-dont-list-msbuild-folder.patch'])
